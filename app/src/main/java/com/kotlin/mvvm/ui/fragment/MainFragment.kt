...
import com.kotlin.mvvm.app.base.BaseFragment
import com.kotlin.mvvm.databinding.FragmentMainBinding
import com.next.easynavigation.view.EasyNavigationBar


class MainFragment : BaseFragment<BaseViewModel, FragmentMainBinding>() {

    private val tabText = arrayOf("专题", "干活", "福利")

    //未选中icon
    private val normalIcon =
        intArrayOf(R.drawable.icon_main, R.drawable.icon_main, R.drawable.icon_main)

    //选中时icon
    private val selectIcon =
        intArrayOf(R.drawable.index1, R.drawable.index1, R.drawable.index1)
...
//            .centerTextStr("发现")
//            .centerImageRes(R.drawable.ic_back)
...
//            .setMsgPointMoreWidth(50F)  //消息99+宽度
//            .setMsgPointMoreHeight(40F)  //消息99+高度
            .textSizeType(EasyNavigationBar.TextSizeType.TYPE_DP)  //字体单位 建议使用DP  可切换SP
//            .setOnTabLoadListener {//Tab加载完毕回调
//                mDataBind.navigationBar.setMsgPointCount(0, 7)
//                mDataBind.navigationBar.setMsgPointCount(1, 109)
//                mDataBind.navigationBar.setHintPoint(4, true)
//            }
